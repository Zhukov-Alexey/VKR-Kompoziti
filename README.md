...
Zhukov BKP_final_1.ipynb - начало кода

Zhukov BKP_final_2.ipynb - продолжение кода

Zhukov BKP_final_3.ipynb - завершение кода

Пояснительная записка Жуков А.И..docx - описание работы на 38 стр в формате docx

Презентация.pptx - презентация ВКР для защиты в формате pptx
